...
export const pipelineStages: PipelineStage[] = [
  ...
  },
  {
    ...
    description: 'For state and congressional district level analysis, the Enhanced CPS is cloned to 12,000 copies and recalibrated to match state-level and CD-level administrative targets. This enables geographic policy analysis.',
    icon: '🗺️',
    inputSize: '~400,000 persons (enhanced)',
    outputSize: '12,000 clones (stratified)',
    dataSources: ['IRS SOI by state/CD', 'USDA FNS by state/CD', 'CMS by state'],
    details: [
      '12,000 clones of the enhanced dataset',
      'Top 99.5th percentile filtering',
      'State-level calibration to IRS SOI, SNAP, Medicaid targets',
      'Congressional district level calibration for local policy analysis',
      'Enables geographic distributional analysis of reforms',
    ],
  },
];
